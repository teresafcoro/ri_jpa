...
public class WorkOrderMappingTests {
    ...
    /**
     * When two workOrders are for the same vehicle at the same timestamp, the
     * second cannot be persisted
     */
    @Test(expected = PersistenceException.class)
    public void testRepeated() {
	WorkOrder repeatedWorkOrder = new WorkOrder(workOrder.getVehicle(),
		workOrder.getDate(), "another description");
