...
public class InvoiceTests {
    ...
    /**
     * If the date of the invoice is before 1/7/2012 the VAT (IVA) is 18% and it
     * amounts 250€ + VAT 18%
     */
    @Test
    ...
    /**
     * All the work orders changes its status to INVOICED when added to an
     * invoice
     */
    @Test
     ...
     *
     * It could be problematic if the identity of the work order depends on the
     * date
     * 
