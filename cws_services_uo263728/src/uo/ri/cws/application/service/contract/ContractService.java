...
public interface ContractService {
    ...
    /**
     * This method creates a new contract for a given mechanic. If there already
     * exists an earlier contract for the same mechanic and this is in force, it
     * will be marked as terminated and the settlement will be computed.
     ...
     *           and annuaBaseWage. Other will be ignored. All them, except end
     *           date are mandatory.
     * 
    ...
    /**
     * @param contractId,
     * @return el dto para el contrato con todos los campos rellenados, o nulo
    ...
    /**
     * @param mechanic id
     * @return a list with every ContractsByMechanic_BLDto registered for this
     *         mechanic, probably empty
     * @throws BusinessException        DOES NOT
     * @throws IllegalArgumentException when id is null or empty.
     */
    List<ContractSummaryDto> findContractsByMechanic(String mechanicDni)
